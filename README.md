...
- Add a small **Python detector** that queries CloudWatch Logs / Security Hub APIs and generates a consolidated kill-chain report as per MITRE ATT&CK TTP matrix 
